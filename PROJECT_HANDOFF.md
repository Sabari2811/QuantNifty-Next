...
- The current `main` changes still require post-change CI evidence and a fresh Render deployment/liveness check before claiming production validation complete.
