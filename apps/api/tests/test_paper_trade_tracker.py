...
def test_session_close_boundary_before_cash_session():
    assert not session_close_required("2026-09-07T15:14:59+05:30")
    assert session_close_required("2026-09-07T15:15:00+05:30")
